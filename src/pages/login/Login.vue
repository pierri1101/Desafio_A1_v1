  ...
  <form @submit.prevent="doLogin()" class="form-login">
    <div class="card">
      <div class="card-header text-center">
        <h1 class="mb-0">Desafio Comunidade de Traders 2.0<br>Mês de Outubro</h1>
      </div>
      <div class="card-body">
        <div class="form-group">
          <input required type="email" v-model="email" class="form-control" placeholder="Digite o seu E-mail" />
        </div>
        <div class="form-group">
          <input
            required
